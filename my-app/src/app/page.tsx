  ...
  return(
    <div className="h-screen">
      <Header />
        ...
        <div>
        <p className="text-[22px] w-[571px] font-[libre-bodoni] background: rgba(120, 112, 84, 1); "> An example of intricate workmanship and detail,elegant necklaces and lond and short chains form a part of our desirable collection.</p></div>
